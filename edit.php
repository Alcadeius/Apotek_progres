...
<body>
        ...
        <div class="card border-primary mb-3" style="width: 30rem;margin-left: 500px;margin-top: -511px; height:400px;">
        <div class="card-header"><center><h3>Edit Account <?php echo $data['username']; ?></h3></center></div>
        <div class="card-body text-primary">
        <form action="prosesedit.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
        <label for="" class="form-label">Username</label>
        <input type="text" class="form-control" name="username" value="<?php echo $data['username'] ?>" require id="">
    </div>
    <div class="mb-3">
        <label for="" class="form-label">Password</label>
        <input type="password" class="form-control" name="password" value="<?php echo $data['password'] ?>" require id="">
    </div>
    <div class="mb-3">
        <label for="" class="form-label">Authority User</label>
        <div class="form-check">
        <input class="form-check-input" type="radio" name="leveluser" value="admin"  id="">Admin</div>
        <div class="form-check">
        <input class="form-check-input" type="radio" name="leveluser"  value="karyawan" id="">Karyawan</div>
    </div>
