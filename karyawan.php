...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
            ...
            <div class="col-5" style="margin-top: 70px;margin-left: 430px;"><button id="add" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-plus"></i> Tambah Karyawan</button></div>
            <!-- Modal Insert -->
          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"><center>Tambah Karyawan</center> </h5>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" name="idkaryawan" class="form-control" require="" id="">
                  </div>
                  <div class="mb-3">
                  <label for="" class="form-label">Nama Karyawan</label>
                  <input type="text" name="namakaryawan" class="form-control" id=""  require="">
                  </div>
                  <div class="mb-3">
   ...
   <table style="margin-top: -450px;width: 80%;margin-left: 230px;height: 300px;">
       ...
       <tbody>
        ...
        <tr>
           ...
           <a href="dei.php?idkaryawan=<?php echo $row['idkaryawan'] ?>" class="ed">Edit</a> |
               <a href="hil.php?idkaryawan=<?php echo $row['idkaryawan'] ?>" id="del">Delete</a>
           </td>
        </tr>
        <?php
           }
