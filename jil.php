...
<body>
        ...
        <div class="card border-primary mb-3" style="width: 30rem;margin-left: 500px;margin-top: -500px; height:400px;">
        <div class="card-header"><center><h3>Edit Account <?php echo $data['idsupplier']; ?></h3></center></div>
        <div class="card-body text-primary">
        <form action="las.php" method="POST">
    <div class="mb-3">
        <label for="" class="form-label">Nama Karyawan</label>
        <input type="hidden" name="idsupplier" value="<?php echo $data['idsupplier'];?>">
        <input type="text" class="form-control" name="perusahaan" value="<?php echo $data['perusahaan'] ?>" require id="">
    </div>
    <div class="mb-3">
