...
<body>
        ...
        <div class="card-header"><center><h3>Edit Account <?php echo $data['idkaryawan']; ?></h3></center></div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="namakaryawan" value="<?php echo $data['namakaryawan'] ?>" require id="">
    </div>
    <div class="mb-3">
